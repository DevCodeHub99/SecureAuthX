    ...
    <div className="min-h-screen py-4" style={{ backgroundColor: "#ECFAE5" }}>
      <div className="px-2 max-w-sm mx-auto">
        ...
        >
          ...
          {/* Error Message */}
          {error && (
            <div className="rounded-2xl bg-red-100 mt-4 py-3 px-4 text-center text-red-600 font-semibold text-sm">
              {error}
            </div>
          )}
          ...
          <div className="my-4 flex items-center">
            ...
            <span className="px-6 text-sm font-medium" style={{ color: "#255F38" }}>
              or
            </span>
            <div className="flex-1 h-px" style={{ backgroundColor: "#CAE8BD" }}></div>
          </div>
