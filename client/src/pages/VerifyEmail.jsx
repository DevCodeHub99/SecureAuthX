...
export default function VerifyEmail() {
  ...
  useEffect(() => {
    ...
    const verify = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_URL}/verify-email?token=${token}&email=${encodeURIComponent(email)}`, {
          method: "GET",
          credentials: "include"
        });
          ...
          <div className="min-h-[120px] flex flex-col items-center justify-center">
            ...
            {status === "success" && (
              <div className="flex flex-col items-center space-y-3">
                ...
                <div>
                  <p className="font-bold text-lg text-green-700">Email Verified!</p>
            ...
            {status === "error" && (
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  <p className="font-bold text-lg text-red-700">Verification Failed</p>
